...
namespace ADO.Access.Access
{
    public class StatusFileDataEssaAccess : IStatusFileDataAccess
    {
        ...
        //Trafos q
        public async Task<Boolean> SaveDataPrecipitacionList(List<QueueStatusPrecipitation> request)
        {

            context.QueueStatusPrecipitations.AddRange(request);
            context.SaveChanges();
            var result = true;
        ...
        public async Task<Boolean> UpdateDataPrecipitacion(QueueStatusPrecipitation request)
        {

            var assetExist = context.QueueStatusPrecipitations.FirstOrDefault(x => x.FileName == request.FileName);
        ...
        public async Task<Boolean> UpdateDataPrecipitacionList(List<QueueStatusPrecipitation> request)
        {
            var result = true;
            foreach (var item in request)
            {
                var assetExist = context.QueueStatusPrecipitations.FirstOrDefault(x => x.FileName == item.FileName);
