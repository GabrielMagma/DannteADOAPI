...
namespace ADO.BL.Services
{
    public class TT2GlobalServices : ITT2GlobalServices
    {
        ...
        public async Task<ResponseQuery<List<string>>> CompleteTT2Originals(ResponseQuery<List<string>> response)
        {
            try
            {
                var completed1 = await BeginProcess();
                Console.WriteLine(completed1);
                var completed2 = await CreateTT2Files();
                Console.WriteLine(completed2);
                var completed3 = await UpdateAllAssetByTT2();
        ...
        public async Task<string> CreateTT2Files()
        {
            try
            {
                Console.WriteLine("CreateTT2Files");
                ...
                foreach (var filePath in files)
                {
                   await ProcessFileAndExecuteOperations(filePath);
                }

                Console.WriteLine("EndCreateTT2Files");
                return "Completed";
            }
            catch (Exception ex)
            {
        ...
        public async Task<string> UpdateAllAssetByTT2()
        {
            try
            {
                Console.WriteLine("UpdateAllAssetByTT2");
                ...
                Console.WriteLine("EndUpdateAllAssetByTT2");
                return "Completed";
            }
            catch (Exception ex)
            {
