...
namespace DannteADOAPI.Controllers
{
    ...
    [ApiController]
    public class FileRayosValidationController : ControllerBase
    {
        readonly IFileRayosValidationServices rayosServices;
        private readonly IHubContext<NotificationHub> _hubContext;

        public FileRayosValidationController(IFileRayosValidationServices _rayosServices, IHubContext<NotificationHub> hubContext)
        {
        ...
        public async Task<IActionResult> ReadFilesRayos(RayosValidationDTO request)
        {
            ...
            await AddMessage(true, "Los archivos de rayos empiezan proceso de validación");
